...
import puzzle.myntra.com.sample.model.entity.NewsEntity;
import puzzle.myntra.com.sample.presenter.news.NewsPresenter;
import puzzle.myntra.com.sample.presenter.news.NewsView;
...
public class MainActivity extends BaseActivity<NewsPresenter> implements NewsView {
  ...
  @Bind(puzzle.myntra.com.sample.R.id.recycler_view) RecyclerView recyclerView;
  @Bind(puzzle.myntra.com.sample.R.id.no_news) View noNewsView;
  @Bind(puzzle.myntra.com.sample.R.id.error_text_view) TextView errorTextView;
